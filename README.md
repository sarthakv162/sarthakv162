...
<!-- Animated intro -->
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=26&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&width=600&lines=Hi+%F0%9F%91%8B%2C+I'm+Sarthak+Verma;Deep+Learning+%7C+PyTorch+%7C+TensorFlow;Building+end-to-end+ML+pipelines;Open+to+collaborations+%26+internships" alt="Typing SVG" />
...
class Sarthak:
    def __init__(self):
        self.role = "AI/ML Engineer (Deep Learning)"
        self.stack = ["PyTorch", "TensorFlow", "scikit-learn"]
        self.focus = "pretraining -> fine-tuning -> evaluation"
        self.currently_exploring = "representation learning & model optimization"

    def collaborate(self):
        return "always open to interesting ML/DL projects 🚀"
```
...
concrete proof (repo links, metrics, dates) far more than generic claims.
-->
...
Also working with: RAG pipelines · vector databases · recommender systems · NLP · Stable Diffusion
...
Also: ETL & data pipelines · data warehousing concepts
